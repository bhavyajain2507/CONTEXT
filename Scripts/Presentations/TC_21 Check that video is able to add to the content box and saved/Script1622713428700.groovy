...
WebUI.click(findTestObject('Article/video tab_click'))

WebUI.setText(findTestObject('Presentations/Add media pop up/video_input field'), 'https://www.youtube.com/watch?v=wY6UyatwVTA')
