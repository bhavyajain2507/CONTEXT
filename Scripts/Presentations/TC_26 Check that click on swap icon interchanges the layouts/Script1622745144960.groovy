...
WebUI.scrollToElement(findTestObject('Presentations/split screenlayout 1/Switch layout icon'), 0)

WebUI.click(findTestObject('Presentations/split screenlayout 1/Switch layout icon'))
