...
WebUI.click(findTestObject('Presentations/Swap title layout icon'))

WebUI.click(findTestObject('Presentations/Swap title section - 2'))

WebUI.click(findTestObject('Presentations/Swap title layout icon'))

WebUI.verifyElementPresent(findTestObject('Presentations/Thumbnail active_title layout'), 0, FailureHandling.STOP_ON_FAILURE)
