...
WebUI.setText(findTestObject('Forms/Form name field'), 'Form 1')

WebUI.click(findTestObject('Forms/Save btn_form'))

WebUI.verifyElementText(findTestObject('Forms/Save success msg_form'), 'Form saved successfully')
