...
WebUI.setText(findTestObject('Article listing page/Search_article listing'), 'published article')
...
WebUI.scrollToElement(findTestObject('Article/Templates/Active sections tab template added/Ac- text sec'), 0)

WebUI.verifyElementAttributeValue(findTestObject('Article/Templates/Active sections tab template added/Ac- text sec'), 'unselectable', 
    'on', 0)
