...
WebUI.setText(findTestObject('Article listing page/Search_article listing'), 'general article')
...
WebUI.click(findTestObject('Copy articles/copied article/Choose brand-copied article'))

WebUI.click(findTestObject('Copy articles/copied article/select brand from dropdown - copied article'))

WebUI.verifyElementNotVisible(findTestObject('Article/Author_creator_article'))
