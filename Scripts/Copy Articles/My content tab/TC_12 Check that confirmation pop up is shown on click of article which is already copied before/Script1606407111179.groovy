...
WebUI.setText(findTestObject('Article listing page/Search_article listing'), 'copied article')
...
WebUI.verifyElementPresent(findTestObject('Copy articles/Already copied article pop up'), 0)
