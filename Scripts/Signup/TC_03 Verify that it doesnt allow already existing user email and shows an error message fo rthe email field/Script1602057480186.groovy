...
WebUI.setText(findTestObject('Signup/Name_input field'), 'Sanju')

WebUI.setText(findTestObject('Signup/Email_input field'), 'hrishikesh.shirsat@ninestack.com')

WebUI.setText(findTestObject('Signup/company_input field'), 'Hyundai')
...
WebUI.verifyElementText(findTestObject('Signup/email_error message field'), 'Denne eposten finnes fra før.')
