...
WebUI.setText(findTestObject('Login page/Username input'), 'qwedcvfgr')

WebUI.setEncryptedText(findTestObject('Login page/Password input'), 'KD0hTFOkUtn/L6tMFkWlsQ==')
