...
WebUI.setText(findTestObject('Login page/Username input'), 'hrishi')
...
WebUI.verifyElementText(findTestObject('Dashboard/Verify text after login on dashboard'), 'Innhold')
