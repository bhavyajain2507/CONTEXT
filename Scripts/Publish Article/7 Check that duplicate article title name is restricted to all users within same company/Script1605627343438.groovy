...
WebUI.setText(findTestObject('Article/Article title_header'), 'Article 1')
...
WebUI.verifyElementText(findTestObject('Publish pop up/Error msg field_publish url'), 'This name already exists!')
