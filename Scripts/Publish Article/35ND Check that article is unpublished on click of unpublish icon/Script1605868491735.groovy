...
WebUI.setText(findTestObject('Article/Article title_header'), 'Article 7')
...
WebUI.click(findTestObject('Publish pop up/No btn_fb share pop up'))

WebUI.click(findTestObject('Sidebar/Sidebar menu'))

WebUI.click(findTestObject('Sidebar/Articles menu'))

WebUI.setText(findTestObject('Article listing page/Search_article listing'), 'Article 7')
