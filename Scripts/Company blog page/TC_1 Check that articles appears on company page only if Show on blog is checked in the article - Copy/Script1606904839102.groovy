...
WebUI.setText(findTestObject('Article/Article title_header'), 'gf')
...
WebUI.click(findTestObject('Page_Boligkanalen Admin/div_Authenticate Article_control__indicator'))
