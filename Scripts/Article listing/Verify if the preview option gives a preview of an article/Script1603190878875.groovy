...
if (true) {
    WebUI.verifyElementPresent(findTestObject('Article listing page/Published article'), 0)

    WebUI.click(findTestObject('Article listing page/chicken menu -small screen'))

    WebUI.click(findTestObject('Article listing page/Preview button - article'))
}
