...
WebUI.setText(findTestObject('Company/Name field_company'), 'Dream 33')

WebUI.click(findTestObject('Company/Save from btn_company'))

WebUI.verifyElementText(findTestObject('Company/Error_duplicate company name'), 'Name exist')
