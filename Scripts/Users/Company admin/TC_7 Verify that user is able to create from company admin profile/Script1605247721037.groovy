...
WebUI.callTestCase(findTestCase('Users/Company admin/TC_3 Verify that it opens create user page on click of create user button from user listing for superadmin and customer admin'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.uploadFile(findTestObject('Users/profile image user'), 'D:\\Katalon image upload\\image0.jpg')

WebUI.setText(findTestObject('Users/firstname_userprofile'), 'Tony')

WebUI.setText(findTestObject('Users/lastname_userporfile'), 'Naik')

WebUI.setText(findTestObject('Users/username_userprofile'), 'Tony')
...
WebUI.setText(findTestObject('Users/email_userprofile'), 'tony111@test.com')
