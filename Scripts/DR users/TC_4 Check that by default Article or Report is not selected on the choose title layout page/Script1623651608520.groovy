...
WebUI.verifyElementNotChecked(findTestObject('DR user/radio btn_article layout'), 0)

WebUI.verifyElementNotChecked(findTestObject('DR user/radio btn_report layout'), 0)
