...
WebUI.setText(findTestObject('Article/Article title_header'), 'Type report')
...
WebUI.setText(findTestObject('Article listing page/Search_article listing'), 'Type report')
...
WebUI.verifyElementText(findTestObject('DR user/Article - report selected_menu bar_top'), 'R')
