...
WebUI.verifyElementPresent(findTestObject('DR user/radio btn_article layout'), 0)

WebUI.verifyElementPresent(findTestObject('DR user/radio btn_report layout'), 0)
