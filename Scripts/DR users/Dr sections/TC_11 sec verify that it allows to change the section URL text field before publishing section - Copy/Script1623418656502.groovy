...
WebUI.setText(findTestObject('DR sections/Input field_name_section'), 'My section test 44')
...
WebUI.setText(findTestObject('DR sections/Input field_section url'), '32323232')
