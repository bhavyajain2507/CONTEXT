...
WebUI.setText(findTestObject('DR sections/Input field_name_section'), 'My section test 11')

WebUI.click(findTestObject('DR sections/save button section_sidebar'))

WebUI.verifyElementText(findTestObject('DR sections/Error msg_availabilty'), 'Please select availability.')
