...
WebUI.click(findTestObject('Article/Templates/carousel template'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Article/Templates/Add article with video template'))

WebUI.click(findTestObject('Article/Templates/Slide Show template'))
