...
WebUI.click(findTestObject('DR user/Presentation tab _add media pop up'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

WebUI.check(findTestObject('DR user/Presentation select_add media pop up'))
