...
WebUI.setText(findTestObject('Article/Article title_header'), 'My saved article 1')
...
WebUI.setText(findTestObject('Article listing page/Search_article listing'), 'My saved article 1')

WebUI.delay(1)

WebUI.verifyElementPresent(findTestObject('Article listing page/Status-draft article'), 0)
