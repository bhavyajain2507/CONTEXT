...
WebUI.click(findTestObject('Object Repository/Templates/Templates menu button'))

WebUI.click(findTestObject('Article/Templates/Text template'))

WebUI.click(findTestObject('Article/Article overlay'))

WebUI.click(findTestObject('Article/click inbetween text'))

WebUI.sendKeys(findTestObject('Article/click inbetween text'), Keys.chord(Keys.ENTER))

WebUI.verifyElementPresent(findTestObject('Article/add media button verify'), 0)
