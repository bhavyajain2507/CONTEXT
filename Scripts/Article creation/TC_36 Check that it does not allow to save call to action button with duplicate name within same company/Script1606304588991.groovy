...
WebUI.setText(findTestObject('Content box/CTA_btn name'), 'duplicate button')

WebUI.click(findTestObject('Content box/CTA_create btn'))

WebUI.verifyElementText(findTestObject('Content box/CTA_error msg_duplicate btn'), 'CTA button already exists !')
