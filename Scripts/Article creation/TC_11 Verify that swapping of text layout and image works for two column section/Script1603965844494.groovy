...
WebUI.scrollToElement(findTestObject('Article/scroll to added sections/2 column section'), 0)

WebUI.click(findTestObject('Article/scroll to added sections/2 colum section - switch arrow'))
