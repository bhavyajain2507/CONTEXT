...
WebUI.click(findTestObject('Settings sidebar/Meta info tab'))

WebUI.setText(findTestObject('Settings sidebar/Author field'), 'My author name')

WebUI.click(findTestObject('Article/Article overlay'))

WebUI.verifyElementText(findTestObject('Article/Author_creator_article'), 'My author name')
