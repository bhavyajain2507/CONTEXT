...
WebUI.click(findTestObject('Article/Customize bar/bold text'))

WebUI.click(findTestObject('Article/Customize bar/Undo text'))

WebUI.click(findTestObject('Article/Customize bar/Redo text'))
